      ...
      <div className="px-4 pt-4 space-y-5">
        {loading ? (
          <div className="flex items-center justify-center h-48">
            <div className="w-8 h-8 border-4 border-green-100 border-t-[#006B3C] rounded-full animate-spin" />
          </div>
        ) : generating ? (
          <div className="flex flex-col items-center justify-center h-48 gap-3 text-slate-500">
            <div className="w-10 h-10 border-4 border-green-100 border-t-[#006B3C] rounded-full animate-spin" />
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-4 text-center px-6">
            <div className="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center">
              <Activity className="w-8 h-8 text-[#006B3C]" />
            </div>
            <div>
            ...
            <Button className="bg-[#006B3C] hover:bg-[#005530] px-8" onClick={runHealthCheck}>
              Start Health Check
            </Button>
          </div>
        ) : (
